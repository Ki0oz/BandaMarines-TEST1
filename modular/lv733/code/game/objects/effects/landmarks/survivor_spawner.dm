...
#define ISRG_K9_SYNTH_NOTICE "<span class='notice'>Вы — служебный синтетик линейки K9, приданный поисковой группе ISRG. Вы НЕ говорите человеческой речью (только лай, рычание и простые эмоции), НЕ можете самостоятельно пользоваться оружием и сложным снаряжением, и обязаны следовать командам своего кинолога-напарника.</span>"
