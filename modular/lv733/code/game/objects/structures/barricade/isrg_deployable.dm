...
/obj/structure/barricade/deployable/isrg
	...
	icon = 'modular/lv733/icons/isrg_barricade.dmi'
...
/obj/item/stack/folding_barricade/isrg
	...
	icon = 'modular/lv733/icons/isrg_barricade_item.dmi'
	icon_state = "folding-1"
	item_icons = list(
		WEAR_BACK = 'modular/lv733/icons/isrg_barricade_back.dmi',
		WEAR_L_HAND = 'modular/lv733/icons/isrg_barricade_lhand.dmi',
		WEAR_R_HAND = 'modular/lv733/icons/isrg_barricade_rhand.dmi',
	)
